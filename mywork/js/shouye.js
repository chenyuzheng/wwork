...
//  let one=document.querySelector('.jindu>li:first-child')
//  let two=document.querySelector('.litwo')
//  let three=document.querySelector('.lithree')
//  let four=document.querySelector('.lifour')

//  one.onclick=function(){
//    	benji.style.marginTop='0px';
//  }
//  two.onclick=function(){
//    	benji.style.marginTop='-1020px';
//  }
//  three.onclick=function(){
//    	benji.style.marginTop='-2040px';
//  }
//  four.onclick=function(){
//    	benji.style.marginTop='-3060px';
//  }
//  let benji=document.querySelector('.benji')
//  let an=document.querySelectorAll('.jindu>li')
//  for(let i=0;i<an.length;i++){
//  	an[i].onclick=function(){
//  		benji.style.marginTop=`-${i*1020}px`;
//  	}
//  }
//  let input=document.querySelector('.biank')
//  let go=document.querySelector('.y')
...
//  	   		benji.style.marginTop="0px";
//  	   	}else{
//  	   		benji.style.marginTop=`-${n*1020}px`;
//  	   	}
//  	}  
//  }
}
